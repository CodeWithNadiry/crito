      ...
      <div className="px-4 md:px-8 lg:px-20 xl:px-25 py-12 md:py-16 lg:py-20 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10 md:gap-12 lg:gap-16">
        ...
        <article className="flex flex-col gap-4 md:gap-5 w-full max-w-xl lg:max-w-146 text-left">
          ...
          <header className="flex flex-col gap-3 items-start">
            ...
            <h2
              ...
              className="text-[26px] md:text-[30px] lg:text-[36px] font-bold leading-tight text-[#1A1F2E]"
            >
              {t("product_title")}
            </h2>
          </header>
          ...
          <div className="flex flex-col gap-4 md:gap-5 lg:gap-6 mt-2">
            ...
            <p className="text-[15px] md:text-[16px] lg:text-[18px] text-[#6B7280] font-medium">
              {t("product_paragraph_1")}
            </p>

            <p className="text-[15px] md:text-[16px] lg:text-[18px] text-[#6B7280] font-medium">
              {t("product_paragraph_2")}
            </p>
        ...
        <figure className="w-full flex justify-start lg:justify-end lg:flex-1">
          <Image
            ...
            className="w-full max-w-full sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-132.5 h-auto rounded-[20px] shadow-md transition-transform duration-300 hover:scale-105"
          />
        </figure>
      </div>
    </section>
